...
-->
  ...
  <div id="page-wrapper" style="padding:0px 100px 40px 100px;">
    <div class="row">
        <div class="col-lg-12">
           <h3 class="page-header"><font color="black">View more&nbsp;&nbsp;Players details</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
               ...
               <tr>
                    ...
                    <td>${ply.phoneno}</td> 
                    <td>${ply.club}</td> 
                    <td><a href="playerhomescore/${ply.username}"><button class="btn btn-success">View Score</button></a></td>
            </c:forEach>  
            </tbody>
        </table>
