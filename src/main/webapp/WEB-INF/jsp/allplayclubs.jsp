...
-->
  ...
  <div id="page-wrapper" style="padding:0px 100px 40px 100px;">
    <div class="row">
        <div class="col-lg-12">
           <h3 class="page-header"><font color="black">View more&nbsp;&nbsp;Match details</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
   			 <form:form method="POST" action="" >
               	 <tr>
               	    <td><form:input type="text" path="matchname" readonly=""/></td>  
	  			 	<td><form:input type="text" path="matchdate" readonly=""/></td>
	  			 	<td><form:input type="text" path="matchtime" readonly=""/></td> 
                    <td><form:input type="text" path="club1" readonly=""/></td> 
                    <td><form:input type="text" path="club2" readonly=""/></td> 
                  </tr>
                </form:form> 
            </tbody>
        </table>
