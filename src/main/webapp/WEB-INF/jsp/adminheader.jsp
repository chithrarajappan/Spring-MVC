    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <!-- /.dropdown -->
                <li class="dropdown">
                    <a class="dropdown-toggle" href="viewclub">
                       Clubs
                    </a>
                ...
                <li class="dropdown">
                 ...
                 <li class="dropdown">
                    <a class="dropdown-toggle" href="viewticketbooking">
                       TicketBooking
                    </a>     
                </li>
                <!-- /.dropdown -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="adminviewclubscore">View Clubs Score</a>
                                </li>
...
-->
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="adminviewplayerscore">View Players Score</a>
                                </li>
                            </ul>
