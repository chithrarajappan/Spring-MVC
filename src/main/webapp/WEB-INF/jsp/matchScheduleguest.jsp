  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar" align="">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="matchSchedule">Matches</a></li>
...
-->
  ...
  <div id="page-wrapper" style="padding:0px 100px 40px 100px;">
    <div class="row">
        <div class="col-lg-12">
           <h3 class="page-header"><font color="black">View &nbsp;Match Schedule details</font></h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
  <div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Match Schedule</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        ...
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
               ...
               <tr>
               		<td>${ms.schedulename}</td>  
                    <td>${ms.scheduledate}</td> 
                    <td>${ms.scheduletime}</td>
                    <td><a href="allplayclubs/${ms.scheduledate}"><button class="btn btn-success">View More</button></a></td>
